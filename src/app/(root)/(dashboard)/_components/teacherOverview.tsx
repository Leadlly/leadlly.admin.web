...
const TeachersOverview = () => {
  return (
    <div className="w-full bg-[#FCFCFC] p-6 rounded-3xl shadow-section border-[1px] border-[#2E77D58C] hover:border-[#204a808c] px-14">
      <h2 className="text-2xl font-semibold mb-6">Teachers Overview</h2>

      <div className="grid grid-cols-2 gap-10 mb-6">
        <div>
          <h3 className="text-gray-600 mb-2 md:text-xl">Total Teachers</h3>
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl md:text-3xl font-semibold">24</span>
          </div>
        </div>

        <div>
          <h3 className="text-gray-600 mb-2 md:text-xl">Departments</h3>
          <div className="flex items-center gap-2">
            <svg
              width="21"
              height="21"
            ...
            <span className="text-2xl md:text-3xl font-semibold">14</span>
          </div>
        </div>

        <div>
          <h3 className="text-gray-600 mb-2 md:text-xl">Active Classes</h3>
          <div className="flex items-center gap-2">
            <svg
              width="18"
              height="21"
        ...
        <div>
          <h3 className="text-gray-600 mb-2 md:text-xl">Satisfaction Rate</h3>
          <div className="flex items-center gap-2">
            <svg
              width="24"
              height="21"
      ...
      <Link
        href="/batches"
        className="bg-[#2E77D524] hover:bg-[#4283d824] text-[#0DA21B] text-xl md:text-2xl flex items-center justify-center gap-2 py-3 rounded-md transition"
      >
        <span>🎓</span>
        View Teachers
      </Link>
