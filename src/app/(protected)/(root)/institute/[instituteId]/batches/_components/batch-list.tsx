            ...
            >
              {coverPreview ? (
                <>
                  ...
                  <img src={coverPreview} alt="Cover preview" className="w-full h-full object-contain bg-white" />
                  <button
                    type="button"
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-3 mb-4">
                  <div className={`w-11 h-11 shrink-0 rounded-xl overflow-hidden bg-gray-50 ${batch.images?.[0]?.url ? "" : `${getBatchLogoBg(batch.name)} flex items-center justify-center text-white`}`}>
                    {batch.images?.[0]?.url ? (
                      // eslint-disable-next-line @next/next/no-img-element
                      <img src={batch.images[0].url} alt={batch.name} className="w-full h-full object-contain" />
