...
export const signUpUser = async (data: SignUpDataProps) => {
  try {
    const response = await fetch(
      `${import.meta.env.VITE_PUBLIC_ADMIN_API_BASE_URL}/api/auth/register`,
      {
        method: "POST",
        headers: {
...
export const forgotPassword = async (data: ForgotPasswordProps) => {
  try {
    const res = await fetch(
      `${import.meta.env.VITE_PUBLIC_ADMIN_API_BASE_URL}/api/auth/forgetpassword`,
      {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
...
export const resetPassword = async (
  ...
  try {
    const res = await fetch(
      `${import.meta.env.VITE_PUBLIC_ADMIN_API_BASE_URL}/api/auth/resetpassword/${token}`,
      {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
...
export const getUser = async () => {
  ...
  try {
    const res = await fetch(
      `${import.meta.env.VITE_PUBLIC_ADMIN_API_BASE_URL}/api/auth/user`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
export const studentPersonalInfo = async (data: StudentPersonalInfoProps) => {
  ...
  try {
    const res = await fetch(
      `${import.meta.env.VITE_PUBLIC_ADMIN_API_BASE_URL}/api/user/profile/save`,
      {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
